...
const { blake2AsHex, encodeAddress, decodeAddress } = require('@polkadot/util-crypto');
...
deriveAccount(
[  ...compactAddLength(stringToU8a('pallet-bridge/account-derivation/account')),
  ...stringToU8a('rlto'),
  ...decodeAddress('5sauUXUfPjmwxSgmb3tZ5d6yx24eZX4wWJ2JtVUBaQqFbvEU')]
);

console.log('expected: 5G6Vkt2VhS8occc66oUFZCSy56i45nuYmYZ4XiWgHAJbUiPW');
console.log('decodedAddress',decodeAddress('5sauUXUfPjmwxSgmb3tZ5d6yx24eZX4wWJ2JtVUBaQqFbvEU'));
